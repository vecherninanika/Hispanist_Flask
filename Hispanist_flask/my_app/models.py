...
class User(UserMixin, db.Model):
    ...
    words = db.relationship(
        "Word", secondary=user_to_word, back_populates="users", cascade="all, delete"
    )
...
class Role(db.Model):
    ...
    users = db.relationship(
        "User", backref="user", lazy=True, cascade="all, delete-orphan"
    )


article_to_topic = db.Table(
    "article_to_topic",
...
class Word(db.Model):
    ...
    users = db.relationship(
        "User", secondary=user_to_word, back_populates="words", cascade="all, delete"
    )
